"""7. Crie uma função que, dada uma lista de strings:
a) Execute os pontos anterior (6 e 5 por esta ordem) e retorne uma String
CamelCase. À semelhança do join(), mas utilizando o reduce."""
...
def lista_para_camel_case(lista):
    palavras = filtra_palavras(expande_palavras(lista))
    return reduce(lambda acc, palavra: acc + palavra.capitalize(), palavras, "")
...
resultado_lista_camel_case = lista_para_camel_case(lista_strings)
...
print("Lista para String CamelCase:", resultado_lista_camel_case)